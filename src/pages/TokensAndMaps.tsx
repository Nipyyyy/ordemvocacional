...
const TokensAndMaps: React.FC = () => {
    ...
    },
    {
      ...
      tokens: [
        ...
        },
        {
          id: 'cin-2',
          name: 'Ator',
          description: 'Profissional fazendo gravação de filme',
        ...
        },
        {
          id: 'cin-3',
          name: 'Atriz',
          description: 'Profissional atuando em cena de filme',
    ...
    },
    {
      ...
      tokens: [
        ...
        },
        {
          id: 'zoo-3',
          name: 'Guia',
          description: 'Profissional conduzindo visitação no zoológico',
  ...
  const npcTokens: Token[] = [
    ...
    {
      id: 'visitante-zoo',
      name: 'Aluno que tem paralisia cerebral',
      description: 'Estudante com paralisia cerebral',
