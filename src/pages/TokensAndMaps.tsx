    ...
    <div className="min-h-screen pt-24 pb-16">
        <div className="container mx-auto px-4">
            ...
            {teamMembers.map((member, index) => (
              ...
              >
                <div className="relative">
                  {/* Card do membro */}
                  <div className="glass-container rounded-2xl p-6 hover:border-white/40 transition-all duration-500 hover:transform hover:scale-105">
                    {/* Foto */}
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="glass-container rounded-3xl p-8 overflow-hidden">
              {/* Título da seção */}
